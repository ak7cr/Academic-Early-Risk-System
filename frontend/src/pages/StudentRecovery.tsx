  ...
  return (
    <div className="flex h-screen bg-[#F9FAFB]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <TopNavbar title="Recovery Plan" subtitle="Personalized academic recovery strategies" userName="Student Name" />
        <div className="flex-1 overflow-y-auto p-8">
          <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
            <div className="max-w-md mx-auto">
              <HeartPulse className="w-16 h-16 mx-auto mb-4 text-gray-400" />
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Recovery Plan</h2>
              <p className="text-gray-600">This feature is coming soon. You'll receive personalized recovery plans based on your risk level here.</p>
            </div>
          </div>
        </div>
      </div>
